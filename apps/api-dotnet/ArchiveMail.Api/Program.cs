...
builder.Services.AddSingleton<ArchiveCombineService>();
builder.Services.AddHostedService(serviceProvider => serviceProvider.GetRequiredService<ImportCoordinator>());
builder.Services.AddHostedService<ArchiveCombineCoordinator>();
...
builder.Services.AddHostedService<OrganizeCoordinator>();
